...
Declare Sub INS_CLC  'Clear Carry
Declare Sub INS_CLD  'Clear Decimal 
Declare Sub INS_CLI  'Clear Interrupt
Declare Sub INS_CLV  'Clear Overflow
...
Declare Sub INS_INX	'Increment X
Declare Sub INS_INY	'Increment Y
...
Declare Sub INS_NOP	'No Operation
...
Declare Sub INS_SEC	'Set Carry Flag
Declare Sub INS_SED	'Set Decimal Flag
Declare Sub INS_SEI	'Set Interrupt Flag
...
Declare Sub INS_TSX	'Transfer Stack to X
Declare Sub INS_TXA	'Transfer X to Accumulator 
Declare Sub INS_TXS	'Transfer X to Stack
Declare Sub INS_TXY	'Transfer X to Y
Declare Sub INS_TYA	'Transfer Y to Accumulator
Declare Sub INS_TYX	'Transfer Y to X
